...
const Simplify : FC = () => {
  return (
    <section className='bg-bright-red px-5 md:px-12 flex-col md:flex-row space-y-10 text-center flex justify-between lg:py-20 lg:px-28 items-center relative'>
