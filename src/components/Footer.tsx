  ...
  return (
    <footer className="px-10 lg:px-16 flex flex-col-reverse gap-y-10 lg:gap-0 lg:flex-row justify-between py-16 bg-very-dark-blue h-auto">
      <div className="items-center md:items-start lg:justify-between flex flex-col-reverse lg:flex-col gap-10">
        ...
        <div className="flex items-center justify-between md:justify-start md:gap-5 lg:gap-3 w-full">
          <Link to="/">
            <img
              src={facebook}
              alt="facebook-link"
      ...
      <div className="flex lg:justify-between gap-24 lg:gap-40">
      ...
      <div className="flex flex-col justify-between">
        <form action="" className="flex gap-3 md:w-[350px]">
          ...
          <button
            type="submit"
            className="bg-bright-red text-white rounded-full px-7 py-[10px] font-medium w-fit h-fit"
          >
            Go
          </button>
        </form>
